...
export default function Card_C4() {
  useEffect(() => {
    AOS.init({ duration: 2500 }); // animation duration = 1000ms
  }, []);
  return (
    <div className='m-auto rounded-md md:rounded-[20px] shadow-lg overflow-hidden' data-aos="zoom-out-left" >
      ...
      <div className='lg:w-full lg:h-[30%] md:h-[35%] h-[50%]  lg:pt-[20px] pb-3 md:pb-4 lg:ml-[15px] ml-2 w-full '>
