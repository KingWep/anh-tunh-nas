    ...
    return(
        <>
            <div className="w-full md:pb-20 ">
                <div className="flex justify-center flex-col items-center pt-14" data-aos="fade-up"
      data-aos-anchor-placement="bottom-bottom">
                ...
                <div className="w-full  pb-10 md:px-16 mt-10 md:flex md:gap-4 lg:flex lg:gap-6 md:flex-row flex gap-10 px-5 flex-col justify-center" >
                    <div className="py-16 px-4 text-center flex flex-col items-center justify-center rounded-[16px] border-[1px] border-gray-400" data-aos="fade-up"
      data-aos-anchor-placement="bottom-bottom">
