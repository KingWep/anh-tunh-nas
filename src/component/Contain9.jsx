    ...
    return (
        <>
            ...
            <div className='md:hidden'>
                <div className='w-[90%]  flex m-auto items-center flex-col text-center pt-10 pb-10 '>
                ...
                <div className='w-[90%] m-auto flex flex-wrap justify-between pt-5 pb-5 '>
                    <div className='w-[48%] h-[220px] rounded-[16px] overflow-hidden mt-5'>
                ...
                <div className='w-[90%] m-auto flex justify-center items-center mt-5'>
            ...
            <div className='md:block lg:block hidden'>
                <div className='lg:w-[40%] md:w-[70%]  m-auto items-center flex-col text-center pt-10 pb-10'>
                ...
                <div className='lg:w-[80%] md:w-[90%] flex m-auto flex-wrap justify-between pt-5 pb-10'>
                    <div className='w-[24%] lg:h-[340px] md:h-[230px] rounded-[16px] overflow-hidden mt-5'>
                        <img src="/image/c9.1.png" alt="" className='w-full h-full object-cover' />
                    </div>
                    <div className='w-[24%] lg:h-[340px] md:h-[230px] rounded-[16px] overflow-hidden mt-5'>
                        <img src="/image/c9.1.png" alt="" className='w-full h-full object-cover' />
                ...
                <div className='w-[90%] m-auto flex justify-center items-center md:mt-3 lg:mt-5'>
                    <FaInstagram className='text-[25px] text-red-600' />
                    <h1 className='font-bold text-[20px] ml-2'>Follow us</h1>
                </div>
            </div>
