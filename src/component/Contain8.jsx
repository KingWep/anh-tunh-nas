    ...
    return (
        <>
            ...
            <div className='w-full  bg-red-100 flex flex-col justify-center items-center mt-20 pb-14 md:hidden'>
                ...
                <div className='w-[90%] rounded-[16px] pb-5 border border-gray-400 flex md:flex-row flex-col items-center bg-white' data-aos="zoom-out-left">
                    <div className='w-[50px] h-[50px] rounded-full flex justify-center items-center border mt-5 border-red-600' data-aos="fade-up"
                        data-aos-anchor-placement="bottom-bottom">
                    ...
                    <div className='w-[80%] flex flex-col items-center text-center' data-aos="fade-up"
                        data-aos-anchor-placement="bottom-bottom">
                        <h1 className='font-bold mt-3'>Shop Styles</h1>
                        <p className='mt-3'>Browse our curated collections for Men, Women, Kids & Accessories.</p>
                    </div>
            ...
            {/* PC */}
            <div className=' w-full  bg-red-100 flex-col justify-center items-center mt-20 pb-14 hidden md:flex' data-aos="zoom-out-left">
                <div className='w-full flex flex-col justify-center items-center pt-14 pb-12' data-aos="fade-up"
                        data-aos-anchor-placement="bottom-bottom">
                    <h1 className='font-bold text-[30px]'>How It Works</h1>
                    <p className='text-[15px]'>Just Pick, Pack and Ship</p>
                ...
                <div className='w-[90%] lg:h-[200px] md:h-[230px] rounded-[16px] border border-gray-400 flex justify-around flex-row items-center'>
                    <div className='lg:w-[30%] md:w-[30%] flex flex-row items-center md:justify-around lg:justify-between' data-aos="fade-up"
                        data-aos-anchor-placement="bottom-bottom">
